export default function Facts(){
    return <section className='facts'>
        ...
        <h4 className="facts__header">ZIEMNIACZANE CIEKAWoSTKI</h4>

        <div className='facts-items'>
            <div className='facts-item facts-item__green'>
                <div className='facts-item__inner'>
                <img src="./potato_facts.png" className="facts-item__potato-icon"></img>
                    <h6 className="facts-item__header">
                        KIEDY I DZIĘKI KOMU ZIEMNIAKI TRAFIŁY DO POLSKI?
                    </h6>
                    <img src="./flip.png" className="facts-item__flip-icon"></img>

                </div>
            </div>

            <div className='facts-item facts-item__red'>
            <div className='facts-item__inner'>
                <img src="./potato_facts.png" className="facts-item__potato-icon"></img>
                    <h6 className="facts-item__header">
                    NA ILU HEKTARACH ZIEM W POLSCE UPRAWIANE SĄ ZIEMNIAKI?
                    </h6>
                    <img src="./flip.png" className="facts-item__flip-icon"></img>

                </div>
            </div>
            <div className='facts-item facts-item__orange'>
            <div className='facts-item__inner'>
                <img src="./potato_facts.png" className="facts-item__potato-icon"></img>
                    <h6 className="facts-item__header">
                    ILE TON ZIEMNIAKÓW PRODUKOWANYCH JEST W POLSCE?
                                     </h6>
                    <img src="./flip.png" className="facts-item__flip-icon"></img>
        ...
        <div className="clouds-facts-section">
        <svg xmlns="http://www.w3.org/2000/svg" width="282" className='clouds-facts-section__item clouds-facts-section__one' height="124" fill="none" viewBox="0 0 282 124">
        ...
        <svg xmlns="http://www.w3.org/2000/svg" width="157" className='clouds-facts-section__item clouds-facts-section__two' height="71" fill="none" viewBox="0 0 157 71">
            <path fill="#F9FBFC" stroke="#000" class="cloud-svg" stroke-miterlimit="10" stroke-width="3" d="M25.558 32.054c.053-1.842.391-5.42 2.588-9.04 3.654-6.056 10.773-9.444 17.595-8.957 4.806.339 8.333 2.52 10.181 3.896 1.405-1.8 3.834-4.404 7.594-6.31 8.143-4.128 16.19-1.757 18.145-1.111 1.647-1.81 5.302-5.336 11.11-7.241 2.387-.784 9.77-2.816 17.955.74 8.533 3.695 12.061 10.894 12.853 12.641.106.074.275.201.475.35 7.752 5.62 14.079 5.832 18.335 7.611 7.583 3.165 13.825 13.519 12.41 22.274-1.585 9.792-12.283 14.64-15.188 15.964-11.829 5.357-23.14 1.43-25.918.37-1.668 1.335-7.91 6.003-17.035 5.749-8.058-.222-13.561-4.15-15.367-5.568a15.28 15.28 0 0 1-8.143 1.672 15.29 15.29 0 0 1-7.403-2.593c-3.39 1.926-11.27 5.812-21.958 5.642-11.49-.18-19.686-4.954-22.929-7.082-.602.264-7.245 3.091-13.222-.73-1.3-.837-4.204-3.028-5.26-6.787C.19 45.7 8.206 38.575 9.283 37.612c6.337-5.632 14.068-5.632 16.275-5.547v-.011Z"/>
            <path fill="#D6E1E5" d="M124.439 45.149c-2.172-4.274-7.319-3.105-10.736-1.19-.433.242-.955-.252-.684-.685 1.608-2.661 3.237-6.42 1.468-9.414-1.428-2.42-4.222-3.588-6.926-3.78-7.087-.494-13.53 3.669-16.285 10.17-.14.333-.724.323-.864 0-1.458-3.296-3.961-7.156-8.002-7.267-3.9-.111-7.127 2.238-9.811 4.848-.332.323-.825.07-.855-.353-.271-3.487-.904-8.577-4.252-10.613-2.352-1.431-5.157-.948-7.489.282-5.85 3.104-10.102 9.212-11.902 15.502-.13.443-.894.524-.965 0-.341-2.308-1.216-6.32-3.98-6.894-2.966-.615-4.675 2.761-5.65 4.999-.11.242-.472.313-.683.181-4.051-2.56-10.023-3.517-11.49 2.39a10.263 10.263 0 0 0 .15 5.543c2.232.05 4.484-.162 6.686.302a.75.75 0 0 1 .482.06c.13.061 9.972 4.395 18.014 4.89 4.895.302 8.966-.837 11.52-1.553a43.082 43.082 0 0 0 6.282-2.298c.131.151.332.353.593.584 1.96 1.734 4.353 1.926 5.419 1.996 1.618.111 4.03.272 5.358-1.3a3.41 3.41 0 0 0 .633-1.14 11.445 11.445 0 0 0 2.794 2.712c3.368 2.268 7.067 1.976 10.686 1.633 2.734-.252 7.057-1.008 11.982-3.457a.84.84 0 0 1 .945-.605c5.388.786 10.967 1.22 16.335.353 1.588-1.522 2.443-3.568 1.257-5.907l-.03.01Z"/>
        </svg>

        <svg xmlns="http://www.w3.org/2000/svg" width="194" className='clouds-facts-section__item clouds-facts-section__three' height="89" fill="none" viewBox="0 0 194 89">
            <path fill="#F9FBFC" stroke="#000" class="cloud-svg" stroke-miterlimit="10" stroke-width="3" d="M26.567 44.776c.24-1.83 1.93-13.18 12.19-20.08 8.53-5.73 19.75-6.23 29.27-1.39 1.95-2.36 6.57-7.32 14.29-10.11 9.29-3.35 17.34-1.5 20.21-.7 1.82-1.76 12.98-12.22 27.73-10.25 6.11.82 18.02 4.46 20.67 13.19.45 1.48.54 2.8.53 3.74.69-.13 15.82-2.81 25.84 8.55 8.39 9.52 6.51 21.29 6.24 22.81 1.33.48 5.95 2.32 7.66 6.77 1.85 4.82-.9 9.61-2.14 11.76-8.26 14.36-44.21 10.95-46.69 10.69-5.6 2.79-16.4 7.26-30.67 7.46-15 .22-26.39-4.38-32.07-7.14-3.57 2.19-14.42 8.2-29.12 6.86-12.46-1.14-21.02-6.95-24.48-9.59-4.81 3.58-11 4.32-15.96 1.83-6.29-3.15-7.57-9.98-7.79-11.18-1.47-7.86 3.34-13.87 4.39-15.19 7.03-8.75 18.6-8.13 19.89-8.04l.01.01Z"/>
            <path fill="#D6E1E5" d="M158.516 66.136a26.327 26.327 0 0 0 3.675-1.453 24.485 24.485 0 0 0 3.416-2.079c-3.695-5.912-14.163-5.145-20.116-3.571-.58.161-1.339-.303-1.259-.969 1.418-13.379-13.804-9-20.476-4.177-.839.605-1.858-.545-1.359-1.372 2.737-4.642 5.194-11.3 3.616-16.77-1.858-6.437-8.29-7.567-13.365-4.157-8.09 5.47-13.924 14.045-19.497 21.936-.46.645-1.259.625-1.718 0-3.656-4.944-8.73-10.393-14.683-12.39-8.67-2.907-12.086 4.742-13.465 12.148-.18 1.008-1.698.928-1.918 0-1.318-5.348-6.073-18.384-13.204-10.716-4.555 4.904-6.053 11.967-5.814 18.505.04.989-1.418 1.412-1.858.504-1.258-2.502-3.755-7.002-7.271-5.63-2.797 1.09-4.695 4.117-5.694 6.841a31.865 31.865 0 0 0-.919 3.067c2.178-.02 4.455-.504 6.693-1.513.24-.101.54-.121.799-.06a1.33 1.33 0 0 1 1.059.12c14.563 8.314 28.287 9.344 43.37 1.716.14-.06.679-.343 1.278-.162.72.202 1.079.949 1.139 1.05 2.677 4.863 25.031 4.701 25.031 4.701 14.703-.1 19.897-1.432 24.532-4.661.479-.343.879-.646 1.139-.848a52.27 52.27 0 0 0 13.564 1.796s7.212 0 13.345-1.876l-.04.02Z"/>
        </svg>
